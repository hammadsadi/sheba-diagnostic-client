const Footer = () => {
  ...
  return (
    <footer className="bg-[#1c2a2b] text-white mt-10 md:mt-20">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center text-teal-600 sm:justify-start">
              <h2 className="text-primary font-extrabold text-2xl md:text-4xl">
                Sheba
              </h2>
            </div>
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-primary transition hover:text-primary-opacity"
                >
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address className="-mt-0.5 flex-1 not-italic text-white transition hover:text-primary">
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-white sm:order-first sm:mt-0">
              &copy; {currentYr} Sheba Diagnostic Center
            </p>
          </div>
        </div>
      </div>
